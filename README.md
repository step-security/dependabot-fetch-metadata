...
**Name:** `step-security/dependabot-fetch-metadata`

Extract information about the dependencies being updated by a Dependabot-generated PR.

## Usage instructions

Create a workflow file that contains a step that uses: `step-security/dependabot-fetch-metadata@v2`, e.g.
...
Since the `step-security/dependabot-fetch-metadata` Action will set a failure code if it cannot find any metadata, you can
